//! 测试PostgreSQL自动建表功能
//! 
//! 这个测试程序验证PostgreSQL适配器在插入数据时是否能正确处理id字段
...
async fn main() -> QuickDbResult<()> {
    ...
    user_data.insert("id".to_string(), DataValue::Int(200));
    user_data.insert("name".to_string(), DataValue::String("李四".to_string()));
    user_data.insert("email".to_string(), DataValue::String("lisi@example.com".to_string()));
    user_data.insert("age".to_string(), DataValue::Int(30));
    user_data.insert("is_active".to_string(), DataValue::Bool(false));
